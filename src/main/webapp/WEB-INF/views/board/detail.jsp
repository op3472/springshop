...
<table class="board" cellpadding="0" cellspacing="0">  
    ...
    <tr align="center" valign="middle"> 
        <td class="boardselect" colspan="5"> 
                ...
                <a href="${pageContext.request.contextPath}/boardmodify.do?num=${vo.board_num}"><img src="${pageContext.request.contextPath}/resources/images/btn_e.jpg"></a>                 
                <a href="${pageContext.request.contextPath}/boarddelete.do?num=${vo.board_num}"><img src="${pageContext.request.contextPath}/resources/images/btn_d1.jpg"></a> 
                </c:if>
