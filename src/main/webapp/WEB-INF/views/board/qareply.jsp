...
<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
 ...
 <body>
	  ...
	  <jsp:include page="/WEB-INF/views/menu.jsp" flush="false"/>
		...
		<div class="content">
<div class="boarddiv">
<form  name="boardform" action="${pageContext.request.contextPath}/qaboardreplygo.do" method="post"  onsubmit="return checkValue2()"> 
<input type="hidden" name="board_id" value="관리자"> 
 <input type="hidden" name="board_num" value="${vo.board_num}"> 
 <input type="hidden" name="board_re_ref" value="${vo.board_re_ref}"> 
 <input type="hidden" name="board_re_lev" value="${vo.board_re_lev}"> 
...
<table class="board" cellpadding="0" cellspacing="0">  
    <tr> 
        ...
        <td> 
            <input name="board_subject" type="text" size="50" maxlength="100" value="Re:${vo.board_subject}"/> 
        </td>         
    </tr> 
    <tr> 
        <th> 
        ...
        <td> 
            <textarea name="board_content" cols="67" rows="15">Re:${vo.board_content}</textarea>             
        </td>         
    </tr> 
    ...
    <tr align="center" valign="middle"> 
        <td class="boardselect" colspan="5"> 
           	<input type="image" src="${pageContext.request.contextPath}/resources/images/btn_r.png"/>&nbsp;&nbsp;
