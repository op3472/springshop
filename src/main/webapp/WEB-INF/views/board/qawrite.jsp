...
<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
 ...
 <body>
	  ...
	  <jsp:include page="/WEB-INF/views/menu.jsp" flush="false"/>
		...
		<div class="content">
<div class="boarddiv">
<form  name="boardform" action="${pageContext.request.contextPath}/qaboardinsert.do" method="post"  onsubmit="return checkValue2()"> 
...
<table class="board" cellpadding="0" cellspacing="0">  
    ...
    <tr align="center" valign="middle"> 
        <td class="boardselect" colspan="5"> 
           	<input type="image" src="${pageContext.request.contextPath}/resources/images/btn_save.gif"/>&nbsp;&nbsp;
